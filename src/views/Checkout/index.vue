...
<template>
  <div class="xtx-pay-checkout-page">
    <div class="container">
      <div class="wrapper">
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button type="primary" size="large" @click="creadOrder">提交订单</el-button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="addressWrapper">
    <div class="text item" :class="{active:item.id === activeAddr.id}" @click="switchAddr(item)" v-for="item in checkInfo.userAddresses"  :key="item.id">
      <ul>
  ...
  <template #footer>
    <span class="dialog-footer">
      ...
      <el-button @click="confirmAddr" type="primary">确定</el-button>
    </span>
  </template>
</el-dialog>
  <!-- 添加地址 -->
